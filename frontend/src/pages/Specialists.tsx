                ...
                >
                  <div className="flex items-start gap-3 sm:gap-4 mb-3 sm:mb-4">
                    ...
                    <div className="min-w-0">
                      <h3 className="font-semibold text-base sm:text-lg truncate">{specialist.name}</h3>
                      <p className="text-xs sm:text-sm text-primary font-medium truncate">{specialist.title}</p>
                    </div>
                  </div>
